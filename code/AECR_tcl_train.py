...
from data.NH_dataloader import TrainDataset, TestDataset
...
if __name__ == "__main__":
    train_dir = '../dataset/NH-HAZE/train'
    test_dir =  '../dataset/NH-HAZE/test'
    # set_seed_torch(3407)

    # train_dir = '../dataset/RESIDE/ITS/train'
    # train_dir = '../dataset/HAZE4K/train'
    ...
    loader_train = DataLoader(dataset=train_set, batch_size=10, shuffle=True, num_workers=12)
    ...
    criterion = []
    print(f'Current device is:{opt.device}')
